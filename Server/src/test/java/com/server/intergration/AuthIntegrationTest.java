...
//
//		assertThat(redisService.getData(key)).isEqualTo(NOT_EXIST_MEMBER_EMAIL);
//	}
//
//	@Test
...
//		String key = stringRedisTemplate.randomKey();
//
//		assertThat(redisService.getData(key)).isEqualTo(EXIST_MEMBER_EMAIL);
//	}
//
//	@Test
...
//		// given
//		AuthApiRequest.Send sendRequest = new AuthApiRequest.Send(NOT_EXIST_MEMBER_EMAIL);
//		String content = objectMapper.writeValueAsString(sendRequest);
//
//		mockMvc.perform(
//			post("/auth/signup/email")
//				.contentType(MediaType.APPLICATION_JSON)
...
//		);
//
//		String signupKey = stringRedisTemplate.randomKey();
//
//		AuthApiRequest.Confirm confirmRequest = new AuthApiRequest.Confirm(
//			NOT_EXIST_MEMBER_EMAIL, signupKey
//		);
//
//		// when
...
//
//		// then
//		String result = redisService.getData(NOT_EXIST_MEMBER_EMAIL);
//
//		confirm
//			.andDo(print())
//			.andExpect(status().isNoContent());
...
//		// given
//		AuthApiRequest.Send sendRequest = new AuthApiRequest.Send(EXIST_MEMBER_EMAIL);
//		String content = objectMapper.writeValueAsString(sendRequest);
//
//		mockMvc.perform(
//			post("/auth/password/email")
...
//		);
//
//		String passwordFindKey = stringRedisTemplate.randomKey();
//
//		AuthApiRequest.Confirm confirmRequest = new AuthApiRequest.Confirm(
//			EXIST_MEMBER_EMAIL, passwordFindKey
//		);
//
//		// when
//		ResultActions confirm = mockMvc.perform(
...
//
//		// then
//		String result = redisService.getData(EXIST_MEMBER_EMAIL);
//
//		confirm
//			.andDo(print())
//			.andExpect(status().isNoContent());
