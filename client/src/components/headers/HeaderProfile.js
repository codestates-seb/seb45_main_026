...
import { HeaderProfileContainer, HeaderProfileImg, HeaderProfileImgContainer, HeaderProfileInfo, HeaderProfileNegativeButton, HeaderProfileWrapper } from './HeaderProfile.style';
        ...
        <HeaderProfileWrapper>
            { userInfo.authority==='ROLE_ADMIN' &&
                <HeaderProfileNegativeButton 
                    isDark={isDark}
                    onClick={()=>{ navigate('/admin') }}>신고 내역 관리</HeaderProfileNegativeButton>
            }
