...
export const RewardNavItem = styled(NavyItem)`
    ...
    border-bottom: 3px solid ${
        props=>
            props.isSelect&&props.isDark?globalTokens.LightGray.value
            : props.isSelect&&!props.isDark?globalTokens.Gray.value
            : !props.isSelect&&props.isDark?globalTokens.Gray.value
...
export const BorderBox = styled.div`
    width: 100px;
    height: 3px;
    background-color: ${props=>props.isDark?globalTokens.Gray.value:globalTokens.LightGray.value};
`
