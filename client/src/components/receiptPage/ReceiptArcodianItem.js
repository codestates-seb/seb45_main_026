  ...
  return (
    <>
      ...
      <ReceiptArcodianItemContainer isDark={isDark}>
        <ReceiptArcodianItemTitleTypo isDark={isDark}>
          {item.videoName}
        </ReceiptArcodianItemTitleTypo>
        <ReceiptArcodianItemChannelTypo isDark={isDark}>
          {item.channelName}
        </ReceiptArcodianItemChannelTypo>
        <ReceiptArcodianItemPriceTypo isDark={isDark}>
...
export const ReceiptArcodianHeader = () => {
  ...
  return (
    <ReceiptArcodianHeaderContainer isDark={isDark}>
      <ReceiptArcodianHeaderinTitleTypo isDark={isDark}>
        강의명
      </ReceiptArcodianHeaderinTitleTypo>
      <ReceiptArcodianHeaderChannelTypo isDark={isDark}>
        채널명
      </ReceiptArcodianHeaderChannelTypo>
      <ReceiptArcodianHeaderPriceTypo isDark={isDark}>
        금액
      </ReceiptArcodianHeaderPriceTypo>
      <ReceiptArcodianHeaderStatusTypo isDark={isDark}>
        결제상태
      </ReceiptArcodianHeaderStatusTypo>
    </ReceiptArcodianHeaderContainer>
  );
