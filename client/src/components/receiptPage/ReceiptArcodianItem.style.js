...
export const ReceiptArcodianCancelButton = styled(NegativeTextButton)`
    ...
    padding: 0;
`
export const ReceiptArcodianHeaderinTitleTypo = styled(ReceiptArcodianItemTitleTypo)`
    text-align: center;
    color: ${props=>props.isDark?globalTokens.LightGray.value:globalTokens.Gray.value};
`
export const ReceiptArcodianHeaderChannelTypo = styled(ReceiptArcodianItemChannelTypo)`
    color: ${props=>props.isDark?globalTokens.LightGray.value:globalTokens.Gray.value};
`
export const ReceiptArcodianHeaderPriceTypo = styled(ReceiptArcodianItemPriceTypo)`
    color: ${props=>props.isDark?globalTokens.LightGray.value:globalTokens.Gray.value};
`
export const ReceiptArcodianHeaderStatusTypo = styled(ReceiptArcodianItemStatusTypo)`
    color: ${props=>props.isDark?globalTokens.LightGray.value:globalTokens.Gray.value};
`