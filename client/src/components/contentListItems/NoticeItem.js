...
export default function NoticeItem({
  ...
  const handleReportAnnouncement = () => {
    return axios
      .post(
        `https://api.itprometheus.net/announcements/${notice.announcementId}/reports`,
    ...
    <>
      <ItemBody isDark={isDark}>
        ...
        {myId === Number(userId) ? (
          ...
          <ButtonContainer>
            <NegativeTextButton onClick={() => setReportModal(true)}>
              신고
            </NegativeTextButton>
          </ButtonContainer>
        )}
      ...
      <ReportModal
        ...
        positiveButtonTitle="취소"
        handleNegativeButtonClick={() => handleReportAnnouncement()}
