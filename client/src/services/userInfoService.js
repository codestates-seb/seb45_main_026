...
export const getUserChannelInfoService = async (authorization, memberId) => {
  try {
    const response = await axios.get(`${ROOT_URL}/channels/${memberId}`, {
      headers: {
        Authorization: authorization,
      },
    });
...
export const deleteProfileImage = async (authorization) => {
  try {
    await axios.delete(`${ROOT_URL}/members/image`, {
      headers: {
        Authorization: authorization,
      },
    });
...
export const getAccountInfoService = async (authorization) => {
  try {
    const response = await axios.get(`${ROOT_URL}/adjustments/account`, {
      headers: {
        Authorization: authorization,
      },
    });
...
// 은행 목록 조회
export const getBankInfoService = async (authorization) => {
  try {
    const response = await axios.get(`${ROOT_URL}/adjustments/banks`, {
      headers: {
        Authorization: authorization,
      },
    });
...
export const deleteUserInfoService = async (authorization) => {
  try {
    const response = await axios.delete(`${ROOT_URL}/members`, {
      headers: {
        Authorization: authorization,
      },
    });
