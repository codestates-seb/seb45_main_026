...
export const RegularInput = styled.input`
  ...
  &:focus {
    outline: ${globalTokens.RegularHeight.value}px solid
      ${(props) =>
        props.isDark ? globalTokens.White.value : globalTokens.Positive.value};
  }
  :-webkit-autofill,
...
export const InputPositiveTypo = styled(SmallTextTypo)`
  width: ${(props) => (props.width ? props.width : "95%")};
  color: ${(props) =>
    props.isDark ? globalTokens.LightNavy.value : globalTokens.Positive.value};
  text-align: end;
`;
