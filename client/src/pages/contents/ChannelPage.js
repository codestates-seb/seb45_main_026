        ...
        <ChannelMainContainer>
          <ProfileContainer>
            ...
            <InforContainer>
              ...
              <ChannelSubscribers isDark={isDark}>구독자 {channelInfor.subscribers}명</ChannelSubscribers>
              <ChannelDescription isDark={isDark}>{channelInfor.description?channelInfor.description:"아직 채널 소개가 없습니다"}</ChannelDescription>
            </InforContainer>
          </ProfileContainer>
